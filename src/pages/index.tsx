  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover the power of seamless dining experiences with Restaurant Booking Engine. A comprehensive solution for table reservations and menu management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover the power of seamless dining experiences with Restaurant Booking Engine. A comprehensive solution for table reservations and menu management.`}
            </Text>
            <Box
