...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const { data, error, isLoading } = (function formatGetByIdApiHook(entity) {
    return formatZenstackApiHook(entity, 'FindFirst');
  })({ where: { tenant_id: session?.user?.tenantId } }, {}, { disabled: !session?.user?.tenantId });
  loading = isLoading;
